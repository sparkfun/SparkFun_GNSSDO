...
=== "<H2>:material-usb-port: ESP32 USB-C</H2>"
	...
	The SparkPNT GNSSDO(+) contains an ESP32-WROVER microcontroller module, which is able to discipline the frequency of the internal temperature-controlled crystal oscillator. By linking the `CONFIG ESP32` USB-C port to your computer, you can view and modify the settings of the ESP32 firmware using a terminal emulator.
