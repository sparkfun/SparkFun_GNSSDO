...
=== "<H2>:material-ethernet:&nbsp;Ethernet</H2>"
	...
	**`1`** - **Connect the GNSS antenna**
	: * Inside your RTK mosaic-T kit, you will find the L1/L2/L5 GNSS "UFO" antenna. It has a TNC connection. Use the supplied TNC-SMA cable to connect the antenna to the mosaic-T **MOSAIC** SMA connection.
	...
	**`3`** - **Provide power**
	...
	Once the mosaic-T has acquired a satellite signal and is connected to the Ethernet network, the OLED will display: the antenna's position as Latitude (Lat), Longitude (Long) and Altitude (Alt); the Ethernet IP (Internet Protocol) network address.
